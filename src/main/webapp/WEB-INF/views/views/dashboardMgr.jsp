...
<head>
  ...
  <jsp:include page="/WEB-INF/views/common/common_include.jsp"></jsp:include>
...
<script type="text/javascript">
	...
	function fListInfResult(data, currentPage) {
		...
		//console.log(data);		
		noticeareavar.listitem = data.noticeList;
	 ...
	 function fNoticeModal(noticeNo) {
		 ...
		 callAjax("/system/noticeDetail.do", "post", "json", true, param, resultCallback2);
	 }
	...
	<div id="wrap_area">
		...
		<div id="container">
			<ul>
				<li class="lnb">
					<!-- lnb 영역 --> <jsp:include
						page="/WEB-INF/views/common/lnbMenu.jsp"></jsp:include> <!--// lnb 영역 -->
				</li>
				<li class="contents">
					<!-- contents -->
                                        ...
                                        <table>
										    <tbody>
										          ...
										          <tr>
										               <td>Vue School </td>
										               <td>
										                       &nbsp&nbsp&nbsp&nbsp&nbsp<a  href="https://vueschool.io/" target="_blank"> 인스턴스</a>
										               </td>
										          <tr>
										          <tr>
										               <td>VueJS 개인 불로그</td>
